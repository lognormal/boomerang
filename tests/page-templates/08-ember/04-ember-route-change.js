...
describe("e2e/08-ember/04-ember-route-change", function() {
	...
	// Beacon 1
	//
	it("Should have sent the first beacon for /04-ember-route-change.html", function() {
		var b = tf.beacons[0];
		assert.isTrue(b.u.indexOf("/04-ember-route-change.html") !== -1);
	});
	...
	// Beacon 3
	//
	it("Should have sent the third beacon for /04-ember-route-change.html", function() {
		var b = tf.beacons[2];
		assert.isTrue(b.u.indexOf("/04-ember-route-change.html") !== -1);
	});
