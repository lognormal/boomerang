...
describe("e2e/08-ember/07-ember-soft-nav-resources", function() {
	...
	// Beacon 1
	//
	it("Should have sent the first beacon for /07-ember-soft-nav-resources.html", function() {
		var b = tf.beacons[0];
		assert.isTrue(b.u.indexOf("/07-ember-soft-nav-resources.html") !== -1);
	});
	...
	// Beacon 3
	//
	it("Should have sent the third beacon for /widget/2", function() {
		var b = tf.beacons[2];
		assert.isTrue(b.u.indexOf("/widget/2") !== -1);
	});
	...
	// Beacon 4
	//
	it("Should have sent the fourth beacon for /widget/3", function() {
		var b = tf.beacons[3];
		assert.isTrue(b.u.indexOf("/widget/3") !== -1);
	});
	...
	// Beacon 5
	//
	it("Should have sent the fifth beacon for /07-ember-soft-nav-resources.html", function() {
		var b = tf.beacons[4];
		assert.isTrue(b.u.indexOf("/07-ember-soft-nav-resources.html") !== -1);
	});
