...
* directive.
*/
describe("e2e/05-angular/07-angular-soft-nav-resources", function() {
	...
	// Beacon 1
	//
	it("Should have sent the first beacon for /07-angular-soft-nav-resources.html", function() {
		var b = tf.beacons[0];
	...
	// Beacon 5
	//
	it("Should have sent the fifth beacon for /07-angular-soft-nav-resources.html", function() {
		var b = tf.beacons[4];
		assert.isTrue(b.u.indexOf("/07-angular-soft-nav-resources.html") !== -1);
	});
