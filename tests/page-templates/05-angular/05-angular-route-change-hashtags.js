...
describe("e2e/05-angular/05-angular-route-change-hashtags", function() {
	...
	// Beacon 1
	//
	it("Should have sent the first beacon for 05-angular-route-change-hashtags.html", function() {
		var b = tf.beacons[0];
		assert.isTrue(b.u.indexOf("05-angular-route-change-hashtags.html") !== -1);
	});
	...
	// Beacon 3
	//
	it("Should have sent the third beacon for /04-angular-route-change.html", function() {
		var b = tf.beacons[2];
		assert.isTrue(b.u.indexOf("#/05-angular-route-change-hashtags.html") !== -1);
	});
