...
describe("e2e/05-angular/04-angular-route-change", function() {
	...
	// Beacon 1
	//
	it("Should have sent the first beacon for /04-angular-route-change.html", function() {
		var b = tf.beacons[0];
		assert.isTrue(b.u.indexOf("/04-angular-route-change.html") !== -1);
	});
