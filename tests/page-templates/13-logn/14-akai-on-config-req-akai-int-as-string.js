...
describe("e2e/13-logn/14-akai-on-config-req-akai-int-as-string", function() {
	...
	it("Should have ak.ai parameter included in the config request.", function() {
		...
		assert.isTrue(window.xhrConfigRequestUrl.indexOf("&ak.ai=567765", queryCharIndex + 7) !== -1, "Expected to see ak.ai query string param");
	});
});
